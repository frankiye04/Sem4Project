...
<script>
    ...
    function generateQR() {
        ...
        timestampBox.innerHTML = `🕒 Generated at: ${formatted}`;
    ...
    // Download QR Code with timestamped filename
    function downloadQR() {
        ...
        const now = new Date();
        const timestamp = now.toISOString().replace(/[:T]/g, "-").split(".")[0]; // e.g., 2025-04-08-14-33-50
